...
def init(params):
	...
	bpy.data.materials["Material.line2"].diffuse_color = (params['lineColor'][0]+0.4, params['lineColor'][1]+0.4, params['lineColor'][1]+0.4)
	bpy.data.materials["Material.line3"].diffuse_color = (params['lineColor'][0]-0.5, params['lineColor'][1]-0.5, params['lineColor'][1]-0.5)
	bpy.data.materials["Material.line4"].diffuse_color = (params['lineColor'][0]-0.4, params['lineColor'][1]-0.4, params['lineColor'][1]-0.4)
